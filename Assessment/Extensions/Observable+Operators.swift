...
//        })
//    }
    public func flatMapLatest<O: ObservableConvertibleType>(selector: @escaping  (Self.Element) throws -> O,onError: (@escaping (Swift.Error) throws ->())) -> RxSwift.Observable<O.Element> {
